        ...
        public override bool OnTouchEvent(MotionEvent e)
        {
            try
            {
                ...
                if (e.Action == MotionEventActions.Down)
                {
                    ...
                    if (endX - additionWidth <= x && x <= endX + additionWidth && y >= 0 &&
                        y <= MeasuredHeight)
                    {
                        if (VideoTimelineViewListener != null)
                        {
                ...
                else if (e.Action == MotionEventActions.Move)
                {
                    if (PressedLeft)
                    {
                        ...
                        ProgressLeft = (startX - PixelUtil.Dp(Context, 16)) / (float)width;
                        if (ProgressRight - ProgressLeft > MaxProgressDiff)
                        {
                            ProgressRight = ProgressLeft + MaxProgressDiff;
                        }
                    ...
                    if (PressedRight)
                    {
                        ...
                        ProgressRight = (endX - PixelUtil.Dp(Context, 16)) / (float)width;
                        if (ProgressRight - ProgressLeft > MaxProgressDiff)
                        {
            ...
            try
            {
                ...
                if (frameNum == 0)
                {
                    ...
                    else
                    {
                        ...
                        FrameWidth = (int)Math.Ceiling((MeasuredWidth - PixelUtil.Dp(Context, 16)) / (float)FramesToLoad);
                    }
                ...
                try
                {
                    ...
                    if (bitmap != null)
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            float scaleX = OuterInstance.FrameWidth / (float)bitmap.Width;
                            float scaleY = OuterInstance.FrameHeight / (float)bitmap.Height;
