                    ...
                    case StyleRowMore.Grid:
                        {
                            ...
                            switch (AppSettings.ShowArticles)
                            {
                                case true:
                                    ...
                                    {
                                        Id = 11,
                                        SectionName = activityContext.GetText(Resource.String.Lbl_Articles),
                                        BadgeCount = 0,
                                        StyleRow = styleRowMore,
                                        Badgevisibilty = false,
    ...
    public class MoreSectionAdapterViewHolder : RecyclerView.ViewHolder
    {
        public MoreSectionAdapterViewHolder(View itemView, Action<MoreSectionAdapterClickEventArgs> clickListener) : base(itemView)
        {
            try
            {
                ...
                ImageView iconArrow = MainView.FindViewById<ImageView>(Resource.Id.icon_arrow);
                if (iconArrow != null)
                    iconArrow.SetImageResource(AppSettings.FlowDirectionRightToLeft ? Resource.Drawable.icon_arrow_left_vector : Resource.Drawable.icon_arrow_right_vector);
