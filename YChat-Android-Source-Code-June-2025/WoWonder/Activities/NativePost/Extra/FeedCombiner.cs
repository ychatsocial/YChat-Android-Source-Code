...
namespace WoWonder.Activities.NativePost.Extra
{
    public class FeedCombiner
    {
        ...
        private readonly NativeFeedType NativePostType;

        public FeedCombiner(PostDataObject post, List<AdapterModelsClass> diffList, Context context, NativeFeedType nativePostType)
        {
            try
            {
                MainContext = context;
                    ...
                    default:
                        {
                            ...
                            if (NativePostType == NativeFeedType.Global)
                            {
                                CountIndex++;
                            }
