...
#pragma warning restore 618
        ...
        public AdapterModelsClass SetFindMoreAlert(string type)
        {
            try
            {
                AlertModelClass alertModel1;
                switch (type)
                {
                    case "Groups" when AppSettings.ShowCommunitiesGroups: 
                        alertModel1 = new AlertModelClass
                        {
                            ...
                            IconImage = Resource.Drawable.ic_more_groups,
                        };
                        break;
                    case "Pages" when AppSettings.ShowCommunitiesPages:
                        alertModel1 = new AlertModelClass
                        {
                            ...
                            IconImage = Resource.Drawable.ic_more_pages,
                        }; 
                        break;
                    default:
                        alertModel1 = new AlertModelClass();
