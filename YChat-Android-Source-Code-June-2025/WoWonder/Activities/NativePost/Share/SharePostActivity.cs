                                            ...
                                            case "MyTimeline":
                                                {
                                                    ...
                                                    if (myProfileActivity != null)
                                                    {
                                                        ...
                                                        var combine1 = new FeedCombiner(result.Data, myProfileActivity.PostFeedAdapter?.ListDiffer, this, NativeFeedType.User);
        ...
        private void GetDataPost()
        {
            try
            {
                ...
                if (PostData != null)
                {
                    ...
                    var combine = new FeedCombiner(PostData, PostFeedAdapter?.ListDiffer, this, NativeFeedType.Share);
