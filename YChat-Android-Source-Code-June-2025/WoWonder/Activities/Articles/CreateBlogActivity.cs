...
namespace WoWonder.Activities.Articles
{
    ...
    public class CreateBlogActivity : BaseActivity
    {
                    ...
                    default:
                        {
                            if (requestCode == Fcr)
                            {
                                ...
                                Uri result = data == null || resultCode != Result.Ok ? null : data.Data;
        ...
        private class MyWebChromeClient : WebChromeClient
        {
            ...
            [Register("onShowFileChooser", "(Landroid/webkit/WebView;Landroid/webkit/ValueCallback;Landroid/webkit/WebChromeClient$FileChooserParams;)Z", "GetOnShowFileChooser_Landroid_webkit_WebView_Landroid_webkit_ValueCallback_Landroid_webkit_WebChromeClient_FileChooserParams_Handler", ApiSince = 21)]
            public override bool OnShowFileChooser(WebView webView, IValueCallback filePathCallback, FileChooserParams fileChooserParams)
            {
                try
                {
                    ...
                    Intent contentSelectionIntent = Environment.GetExternalStorageState(null)!.Equals(Environment.MediaMounted) ? new Intent(Intent.ActionPick, MediaStore.Images.Media.ExternalContentUri) : new Intent(Intent.ActionPick, MediaStore.Images.Media.InternalContentUri);
